# RailsAdmin config file. Generated on September 14, 2012 22:14
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Atbru', 'Admin']
  ...
  # config.included_models = [Registration]
  ...
  #     configure :purchase_order, :string 
